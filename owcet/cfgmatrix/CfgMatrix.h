...
public:
    void addConv(int nodeA, int nodeB, int cycles); //seta uma aresta que conecta dois nos no sentido convencional
    void addLoop(int nodeA, int nodeB, int cycles); //seta uma aresta de loopback
